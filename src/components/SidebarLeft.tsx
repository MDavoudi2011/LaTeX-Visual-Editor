...
import { GripVertical, Trash2, ChevronUp, ChevronDown, MoveUpRight, ArrowDownToLine, CornerDownLeft, ChevronLeft } from 'lucide-react';
...
export function SidebarLeft({ blocks, setBlocks, onNestBlock, onExtractBlock, onAddInnerBlock, activeBlockId }: SidebarLeftProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white border-l border-gray-200 shadow-sm w-full">
      <h2 className="text-sm font-bold text-gray-800 p-4 pb-2 text-center border-b border-gray-200">ساختار سند (Outline)</h2>
